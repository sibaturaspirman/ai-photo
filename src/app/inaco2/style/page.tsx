...
import { INACO_OUTFIT_COUNT, INACO_STORAGE, clearInacoUserData, inacoOutfitPath } from "@/lib/inaco2/constants";
...
export default function InacoStylePage() {
  ...
  useEffect(() => {
    if (!window.localStorage.getItem(INACO_STORAGE.tema)) {
      router.replace("/inaco2/template");
    }

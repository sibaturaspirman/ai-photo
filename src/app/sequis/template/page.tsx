...
export default function SequisTemplatePage() {
  ...
  return (
    <main className="relative isolate flex min-h-dvh w-full items-center justify-center overflow-hidden px-4 py-8">
      <div
      ...
      <div className="flex w-full max-w-5xl flex-col items-center gap-6">
        ...
        <div className="grid w-full mt-8 gap-4 md:grid-cols-2">
          {templates.map((template) => (
            <button
              ...
              className={`overflow-hidden rounded-xl border-4 ${
                selectedTemplate === template.id ? "border-emerald-300" : "border-white/20"
              }`}
            ...
            >
              <div className="relative w-full bg-black/20">
                ...
                {selectedTemplate === template.id ? (
                  <div className="absolute left-1/2 top-1/2 flex h-24 w-24 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-emerald-500 shadow-lg">
